...
struct SquirrelAboutUs: View {
    var body: some View {
        ...
        VStack {
            ...
            Spacer()
//                VStack {
//                Text("Fox squirrels spend most of their time on the ground searching for food and they prefer to be in an area that is next to Woodlands. he squirrel’s tail is a stabilizer for when they go airborne  between trees and branches. Fox squirrels are active through the day and sleep at night.")
//                    .font(.body)
//                    .multilineTextAlignment(.center)
//                    .padding(.horizontal, 5.0)
//                Text("Gray squirrels prefer areas with a dense tree population. Gray squirrels are most active early in the morning and late afternoon. These two types of squirrels may cross paths but don’t necessarily live in the same areas. Their predators are hawks, foxes, coyotes  and house cats.")
//                    .font(.body)
//                    .multilineTextAlignment(.center)
//                    .padding()
//                }
